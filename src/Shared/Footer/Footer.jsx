...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#606c38] text-white">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-[#606c38]  text-white border-base-300">
                ...
                <nav className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-4">
                        <a href="https://facebook.com/" className="text-2xl "> <FaFacebookSquare></FaFacebookSquare> </a>
                        <a href="https://www.youtube.com/" className="text-2xl "> <FaYoutube></FaYoutube> </a>
                        <a href="https://www.instagram.com/" className="text-2xl "> <FaInstagram></FaInstagram> </a>
                    </div>
                </nav>
            </footer>
        </div>
