...
const Register = () => {
    const { userCreate, updateUserProfile, logInWithGoogle } = useContext(AuthContext);
        ...
        <div className=' w-5/6 lg:w-1/2 bg-[#6C0A0F] p-8 rounded-md'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="text-black">
                ...
                <div className='relative'>
                    <p>
                        <input type={show ? 'text' : 'password'} className='w-full my-4 px-3 py-1 text-black' placeholder='Your Password' {...register('password', {
                            required: true,
                            minLength: 6,
                            maxLength: 20,
